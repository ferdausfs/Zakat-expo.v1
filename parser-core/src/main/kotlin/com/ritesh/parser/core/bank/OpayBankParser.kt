...
class OpayBankParser : BankParser() {
    ...
    override fun canHandle(sender: String): Boolean {
        ...
        return normalized.contains("OPAY")
    }
    ...
    override fun extractTransactionType(message: String): TransactionType? {
        ...
        return when {
            lowerMessage.contains("credit") || lowerMessage.contains("received") ||
                lowerMessage.contains("deposit") || lowerMessage.contains("funding") -> TransactionType.INCOME
            lowerMessage.contains("debit") || lowerMessage.contains("withdrawal") ||
                lowerMessage.contains("transfer") || lowerMessage.contains("payment") ||
